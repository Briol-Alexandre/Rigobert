...
<main class="grid-main">
    ...
    <?php if ($gallery): ?>
        <div class="col-start-3 col-end-11 mt-10 flex gap-4">
            <?php foreach ($gallery as $image): ?>
                <a href="<?= $image['url'] ?>"
                    class="gallery-image cursor-pointer block h-full overflow-hidden w-1/3 group relative">
                    <span
    ...
    <section aria-labelledby="us" class="col-span-full grid-main">
        ...
        <img src="<?= $us_image['url'] ?>" alt="<?= $us_image['alt'] ?>"
            class="col-start-3 col-end-11 aspect-video object-cover">
        <a href="<?= $us_link['url'] ?>"
